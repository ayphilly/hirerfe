  ...
  const closeMore = () => {
    if (isOpen === true) {
      ...
      container[0].addEventListener("click", function () {
        var moreContainer = document.querySelector(".profile-box-more");
        moreContainer.className = moreContainer.className.replace(
          " ",
          " hidden"
        );
        setOpen(false);
        ...
        <div className="talent-profile-inner-left">
          ...
          <div className="talent-profile-about">
            <div className="about-inner">
              <p>About</p>
              <p>
                Hi! I believe design is more than creating products and services
                that are understandable and usable, it also needs to bring joy,
                excitement, pleasure and beauty to people's lives.
              </p>
            </div>
          </div>
          ...
          <div className="talent-profile-box">
            <div className="talent-profile-box-inner">
              <Box title="Experience">{exp}</Box>

              <Box title="Education">{edu}</Box>
              <Box title="Licenses & Certifications">{certy}</Box>
            </div>
          </div>
  ...
  return (
    <div className="profile-box-more hidden">
      <div className="more-inner">
        <p>
          <FontAwesomeIcon icon={faFileAlt} className="icon" size="lg" />
          Check CV
        </p>
        <p>
          <FontAwesomeIcon icon={faComment} className="icon" size="lg" />{" "}
          Request Interview
        </p>
        <p>
          {" "}
