        ...
        <div className="hirer-navbar-container">
            <div className="navbar-inner">
                <div className="navbar-inner left">
                    ...
                    <Link className="navbar-inner-nav-link" to="/hirer/searchtalent" style={{textDecoration:'none'}}>Find Talents</Link>
                    <Link className="navbar-inner-nav-link" to="/hirer/postjob" style={{textDecoration:'none'}}>Post A Job</Link>
                    {/* <span className="navbar-inner-nav-link"> Company Reviews </span> */}
                </div>
                <div className="navbar-inner right">
                    <span className="navbar-inner-nav-link"> Help Centre </span>
                    <Link className="navbar-inner-nav-link" to="/" style={{textDecoration:'none'}}>For Talents</Link>
