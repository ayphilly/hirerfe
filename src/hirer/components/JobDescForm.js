...
const JobDescForm = ({ step, previousStep, nextStep }) => {
  return (
    ...
    >
      <div className="f-24 fw-700">Step {step + 1} of 4 &bull; Job Description</div>
      <p className="mb-8">
      ...
      <div>
        ...
        <Field as="textarea" name="jobDescription" rows={5} className="mb-8 classic-input w-100" type="text" />
      </div>
