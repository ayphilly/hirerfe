              ...
              <div className="job-title-inner">
                <div className="job-title-top">
                  <div className="job-title-left">
                    ...
                    <p>
                      {" "}
                      {props.formData.companyName} - {props.formData.location}{" "}
                    </p>
                    <a href="#dummylink" className="job-title-btn">
                      Apply Now{" "}
                    </a>
                  </div>
                  <a href="" onClick={() => props.navigation.go("names")}>
                    Edit
                  </a>
                </div>
                <hr />
                ...
                <div className="job-desc">
                  <div className="job-desc-inner">
                    <p>
                      Bad stuff will happen if you don’t follow those 3 simple
                      Grid rules, exactly. I’ve answered countless Bootstrap
                      questions on Stack Overflow by simply applying those
                      rules. At first this might sound complicated, but it’s
                      really easy once you understand how the Grid works.
                    </p>
                    <p>
