      ...
      <div className="singlejob-inner-col">
        <div className="single-inner-top">
          <div className="single-job-profile">
            <img src={profile} alt="job profile" />
            <div className="single-job-details">
              <p>{props.title}</p>
              <p>{props.company}</p>
              <p>
                {" "}
                {props.location} <strong> • {props.type} </strong>{" "}
              </p>
            </div>
          </div>
        ...
        <div className="single-job-description">
          <p className="description">
            Desktop Technician will provide day to day local \ remote desktop
            support, receive inbound calls, answer questions, troubleshoot and
            document steps performed to, Desktop Technician will provide...
          </p>
        </div>
